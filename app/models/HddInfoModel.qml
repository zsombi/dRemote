...
XmlListModel {
    ...
    query: "/e2abouts/e2about/e2hddinfo"
    XmlRole { name: "hddModel"; query: "model/string()" }
    XmlRole { name: "hddCapacity"; query: "capacity/string()" }
    XmlRole { name: "hddFree"; query: "free/string()" }
}
